                        ...
                        <table class="table table-bordered table-head-fixed table-hover text-nowrap table-sm" id="ID_table">
                            <thead class="<?= $_th_style; ?>">
                                <tr class="text-center">
                                    <th class="col-tab120">ID Modul</th>
                                    <th class="col-tab300">Nama Modul</th>
                    ...
                    <div class="card-footer clearfix" id="ID_divpagination">
                        <div class="row" id="ID_pagination">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 text-left">
                                ...
                                <br>
                                <i style="margin-right: 10px;">Total Data : <?= $module_data_count; ?></i>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="module_name" class="form-control" placeholder="Nama Modul" minlength="3" maxlength="30" id="fil_module_name">
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                <label>Nama Modul</label>
                                <input type="text" name="name" class="form-control" placeholder="Nama Modul" id="module_name" required>
                            </div>
                            <div class="form-group">
                                <label>Deskripsi</label>
                                <textarea name="description" class="form-control" placeholder="Deskripsi Modul" id="module_description"></textarea>
                            </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                <label>Nama Modul</label>
                                <input type="hidden" name="module_id" id="up_module_id" required readonly>
                                <input type="text" name="name" class="form-control" placeholder="Nama Modul" id="up_module_name" required>
                            </div>
                            <div class="form-group">
                                <label>Deskripsi</label>
                                <textarea name="description" class="form-control" placeholder="Deskripsi Modul" id="up_module_description"></textarea>
                            </div>
                            <div class="form-group clearfix">
                                <label>Akses Status</label>
                                <div class="icheck-success">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="module_name" value="<?= $_fil_module_name; ?>">
                                <input type="hidden" name="access_status" value="<?= $_fil_module_access_status; ?>">
                            </div>
                        </div>
                    </div>
                </div>
