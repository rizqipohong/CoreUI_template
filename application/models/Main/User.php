...
class User extends CI_Model
{
    ...
    {
        return $this->db->get_where("main_users", array("id" => $id, "deleted_at" => null))->row(0);
    }
    ...
    public function all()
    {
        return $this->db->get_where("main_users", array("deleted_at" => null))->result();
    }

    public function get_dashboard_data($limit = null, $offset = null, $fullname = null, $status = null)
    {
        ...
        if (!empty($fullname)) {
            $this->db->like('name', $fullname, 'both');
        }
    ...
    {
        return $this->db->insert('main_users', $data);
    }
    ...
    {
        return $this->db->update('main_users', $data, array('id' => $data['id']));
    }
    ...
    public function delete($id)
    {
        ...
        return $this->find($id) ? $this->db->update('main_users', $data, array('id' => $id)) : 0;
    }
    ...
    {
        return $this->db->insert('main_roles_users', $data);
    }
    ...
    public function deleteRoles($user_id, $roles)
    {
        ...
        return $this->db->delete('main_roles_users', array('user_id' => $user_id));
    }
    ...
    public function deleteRole($user_id, $role_id)
    {
        ...
        return $this->db->delete('main_roles_users', array('user_id' => $user_id, 'role_id' => $role_id));
    }
    ...
    public function userWiseRoles($id)
    {
        return array_map(function ($item) {
            return $item["role_id"];
        }, $this->db->get_where("main_roles_users", array("user_id" => $id))->result_array());
    }
