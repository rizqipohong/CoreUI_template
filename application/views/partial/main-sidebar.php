...
<div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <img src="<?php echo base_url('uploads/profile_picture/' . $this->session->userdata('photo')); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
            <a href="<?= $_url_profile; ?>" class="d-block"><?= $this->session->userdata('name'); ?><br></a>
        </div>
    </div>
    <nav class="mt-2">
